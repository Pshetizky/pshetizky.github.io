...
var sets = [
'"מה משמח אותי בחיי כעת?"',
'"מה מרגש אותי בחיי כעת?"',
'"מה מעורר בי הכרת תודה בחיי כעת?"',
'"את מי אני אוהב בחיי כעת?"',
'"מי אוהב אותי בחיי כעת?"',
'"איזה הרגל מחשבתי אני מחוייב/ת ליצור בחיי כעת?"',
'"איזו אמונה תת הכרתית אני מחוייב/ת ליצור בחיי כעת?"'
];
function getNames() {
	return sets[
		Math.floor(Math.random() * sets.length)
