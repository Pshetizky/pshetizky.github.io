...
function	GotoAteret ()
{
	window.open ("https://aterett.co.il/%D7%AA%D7%A8%D7%95%D7%9E%D7%95%D7%AA/");
}
...
//		print ("<meta http-equiv=Content-Type content='text/html; charset=windows-1255'>");
	...
	print ("<style type='text/css'>");
		...
		if (FixedWidth)
		{
			if (SearchBaseForGoogle != "")
				...
				print ("#td1	{background-color: RGB(0,0,135); height: 100px; background-image: url(c_background_html.png); background-repeat: repeat-x; color:white; border-style:none; border:0;}");
		}
		else
	...
	print ("<td id='td1' style='cursor: pointer; text-align: left; font-size:12px; font-family:arial; padding-left:0px; padding-top:6px;' valign='top' onclick='GotoAteret()'>A");
